...
liste = liste.sort do |a, b|
a.downcase[1] <=> b.downcase[1]
end
puts liste 

#Question6
puts "Trie la liste de handle par taille des handle."
puts liste.sort_by{|i| i.length}
...
#Question8
puts "Sors-moi une répartition des handle par taille de 
ces derniers (nombre de handle avec 1 caractère, nombre de 
handle avec 2 caractères, nombre de handle avec 3 caractères,
etc)"
17.times do |i|
count = 0
liste.each do |journalist|
if journalist.length == i 
count += 1
end
end
